...
require (
	...
	github.com/adedayo/git-service-driver v0.1.3-0.20220425091843-98ba4983c712
...
// replace github.com/adedayo/checkmate-plugin v0.4.0 => ../checkmate-plugin

// replace github.com/adedayo/git-service-driver v0.1.2 => ../git-service-driver
