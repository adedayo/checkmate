...
// replace github.com/adedayo/git-service-driver v0.7.2 => ../git-service-driver
// replace github.com/adedayo/checkmate-plugin v0.7.2 => ../checkmate-plugin
// replace github.com/adedayo/checkmate-badger-project-manager v0.7.2 => ../checkmate-badger-project-manager
