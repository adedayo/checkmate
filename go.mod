...
require (
	...
	github.com/adedayo/checkmate-plugin v1.0.6
	github.com/adedayo/git-service-driver v1.0.6
...
require (
	github.com/adedayo/ldap-sync v1.0.6
...
replace github.com/adedayo/checkmate-plugin v1.0.6 => ../checkmate-plugin

replace github.com/adedayo/git-service-driver v1.0.6 => ../git-service-driver

replace github.com/adedayo/ldap-sync v1.0.6 => ../ldap-sync
