...
// replace github.com/adedayo/git-service-driver v0.8.0 => ../git-service-driver
// replace github.com/adedayo/checkmate-plugin v0.8.0 => ../checkmate-plugin
// replace github.com/adedayo/checkmate-badger-project-manager v0.8.0 => ../checkmate-badger-project-manager
