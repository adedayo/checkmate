...
require (
	...
	github.com/adedayo/checkmate-plugin v0.9.4
	github.com/adedayo/git-service-driver v0.9.4
...
require (
	github.com/adedayo/ldap-sync v0.9.4
...
replace github.com/adedayo/checkmate-plugin v0.9.4 => ../checkmate-plugin

replace github.com/adedayo/git-service-driver v0.9.4 => ../git-service-driver

replace github.com/adedayo/ldap-sync v0.9.4 => ../ldap-sync
